function [] = generate_dataset_short(training_set, testing_set, sim_path, gt_path)
...
%   air-rebar standard test
%   generate_dataset([1 2 3 5 6 7 9 10 11], [4 8 12], "./gprMax_output/", "./permittivity_map_images/");
...
% generate_dataset([1 2 3 5 6 7 9 10 11 13 14 15 17 18 19 21 22 23 25 26 27 29 30 31 33 34 35], [4 8 12 16 20 24
% 28 32 36], "~/Softwares/gprMax/simulator_2.1/, "./permittivity_map_images/");

% training = [1:40];
% testing = [4:4:40];
% training(4:4:40) = [];
% generate_dataset(training, testing, "./gprMax_output/", "./permittivity_map_images/");

%% Inserts blank dataset at the start to act as sim0
% blank = imread('blank.png');
% 
% parfor i=1:1200
%     blank_filename = char(sprintf("./combined_images/train/" + '%d.png', i));
%     imwrite(blank, blank_filename);    
% end
...
% parfor i=1:60
%     blank_filename = char(sprintf("./combined_images/val/" + '%d.png', i));
%     imwrite(blank, blank_filename);    
% end
